...
pts1 = np.float32([[0,0],[cols,0],[cols,rows],[0,rows]])    #these points are necesary for the transformation

zoomLevel = 0   #when zoomLevel is positive it zooms in, when its negative it zooms out
processing = True   #boolean variable used for disabling the image processing
maskThreshold=10
